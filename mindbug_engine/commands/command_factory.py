...
class CommandFactory:
    ...
    def _resolve_target(action_type: str, index: int, game):
        ...
        try:
            ...
            # "Mon" jeu
            if action_type == "SELECT_HAND": return me.hand[index]
            if action_type == "SELECT_BOARD": return me.board[index]
            if action_type == "SELECT_DISCARD": return me.discard[index]

            # Jeu "Adverse"
            if action_type == "SELECT_OPP_HAND": return opp.hand[index]
            if action_type == "SELECT_OPP_BOARD": return opp.board[index]
            if action_type == "SELECT_OPP_DISCARD": return opp.discard[index]
